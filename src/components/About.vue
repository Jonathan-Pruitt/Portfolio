...
<template>
  <section id="about">
    ...
    <p>Fullstack Developer focused on building fast, scalable, and resource-lean software and web applications. I have developed a love of the VILT (Vue, Inertia.js, Laravel, TailwindCSS) tech stack for web projects, and I'm partial to C# and Python for software applications. Working with Hardly Inc, I have leveraged asynchronous programming, ORM usage, and component-based architecture to deliver high-impact solutions. Notably, I constructed an AI generated feedback engine for Hardly's 'Interview Practice' tool. By implementing Asynchronous Web Flows and Audio/Video Transcription, I significantly reduced latency between user submission and coach review. I am currently looking for a developer team to which I can contribute my passion for clean code and collaborative problem-solving.</p>
