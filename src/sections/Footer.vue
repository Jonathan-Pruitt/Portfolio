...
import adhd_svg from '@/assets/icons/tags/adhd.svg?component'
import coffee_svg from '@/assets/icons/tags/coffee.svg?component'
        ...
        <div class="container mx-auto flex flex-col items-center justify-center text-center">
          <div class="my-8">
            <div class="mx-auto">
              ...
              <p class="mx-auto font-content text-header max-w-sm text-lg md:text-2xl tracking-wide font-light">Full Stack Developer focusing on workflow improvement tools and utility automation</p>
            </div>
          </div>
          <div class="">
